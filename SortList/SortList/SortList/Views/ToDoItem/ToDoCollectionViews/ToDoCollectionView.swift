...
class ToDoCollectionView: UICollectionView, UICollectionViewDataSource,
UICollectionViewDelegate, ToDoItemCollectionViewCellDelegate {
	...
	func collectionView(collectionView: UICollectionView,
		...
		let cell = self.dequeueReusableCellWithReuseIdentifier(cellIstanceName,
																												forIndexPath: indexPath) as? ToDoItemCollectionViewCell
		...
		cell?.closeImage.addTarget(self,
		                           action: #selector(ToDoCollectionView.deleteCell(_:)),
	...
	func deleteCell(sender: UIButton) {
		...
		//CoreDataUtil.deleteObject(ToDoItem.getEntityNameOfObject(), object: toDoItems[i-1])
		reloadData()
	}
