...
class ToDoListCollectionViewController: UIViewController,
...
DataEnteredDelegate {
	...
	override func viewDidLoad() {
		...
		longPressGesture = UILongPressGestureRecognizer(target: self,
		                                                action: #selector(ToDoListCollectionViewController.handleLongGesture(_:)))
		// swiftlint:disable:previous line_length
		self.toDoCollectionView.addGestureRecognizer(longPressGesture)


		tapPressGesture = UITapGestureRecognizer(target: self,
		                                         action: #selector(ToDoListCollectionViewController.handleTapGesture(_:)))
		// swiftlint:disable:previous line_length
...
extension ToDoListCollectionViewController {
	...
	func pickOutWorkedCell (recivedFromMainListValueCell: ToDoItem?,
	...
	func setParametretoCell(cell: ToDoItemCollectionViewCell,
	                        borderWidth: CGFloat,
	                        borderColor: UIColor) {
	...
	func handleLongGesture(gesture: UILongPressGestureRecognizer) {
		...
		case UIGestureRecognizerState.Began:
			// swiftlint:disable:next line_length
			guard let selectedIndexPath = self.toDoCollectionView.indexPathForItemAtPoint(gesture.locationInView(self.toDoCollectionView))
				else {
					break
			}
	...
	func handleTapGesture(gesture: UITapGestureRecognizer) {
		...
		case UIGestureRecognizerState.Ended:
			// swiftlint:disable:next line_length
			guard let _ = self.toDoCollectionView.indexPathForItemAtPoint(gesture.locationInView(self.toDoCollectionView))
				else {
					break
			}
