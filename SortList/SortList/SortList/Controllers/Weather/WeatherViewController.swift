...
class WeatherViewController: UIViewController {
	...
	*/
	...
	private func loadDataByDefault () {
		// swiftlint:disable:next line_length
		userCityName.text = PlistUtil.getSavedStringValue(nameOfItem: tempItemsInKlass.nameTemporaryForSave,
		                                                  pListName: tempItemsInKlass.nameOfPList)
		//getSaveNamedOfCity()
	}
	private func saveNameOfCity() {
		PlistUtil.saveStringValue(userCityName.text!,
		                          itemName: tempItemsInKlass.nameTemporaryForSave,
		                          plistName: tempItemsInKlass.nameOfPList)
	}
