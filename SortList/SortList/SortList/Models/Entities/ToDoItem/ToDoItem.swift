...
class ToDoItem: NSManagedObject {
	...
	static func insertToDoItemWithItem(item: String?,
	                                   checked: Bool?,
	                                   createdDate: NSDate?,
	                                   colorItem: UIColor?,
	...
	static func rewriteToDoItemWithParameters (inout toDoItemValue: ToDoItem?,
	                                                 item: String?,
	                                                 checked: Bool?,
	                                                 colorItem: UIColor?) {
	...
	static func allToDoItems() -> [ToDoItem]? {
		...
		let array = CoreDataUtil.fetchEntity(entityName as String,
		                                     predicate: nil,
		                                     sortDescriptors: [dateSort]) as? [ToDoItem]
